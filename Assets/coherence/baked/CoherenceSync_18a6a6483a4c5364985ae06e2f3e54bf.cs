...
namespace Coherence.Generated
{
    ...
    public class Binding_18a6a6483a4c5364985ae06e2f3e54bf_b7a859ecfc2a41f79a9cf3745e686ffa : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_18a6a6483a4c5364985ae06e2f3e54bf : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_18a6a6483a4c5364985ae06e2f3e54bf>();
        ...
        {
			["b7a859ecfc2a41f79a9cf3745e686ffa"] = new Binding_18a6a6483a4c5364985ae06e2f3e54bf_b7a859ecfc2a41f79a9cf3745e686ffa(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_18a6a6483a4c5364985ae06e2f3e54bf()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_18a6a6483a4c5364985ae06e2f3e54bf Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_18a6a6483a4c5364985ae06e2f3e54bf>();
            this.bridge = bridge;
