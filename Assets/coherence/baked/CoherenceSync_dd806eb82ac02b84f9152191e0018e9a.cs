...
namespace Coherence.Generated
{
    ...
    public class Binding_dd806eb82ac02b84f9152191e0018e9a_3110cfaea09c4dac92f501522c3faca2 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_dd806eb82ac02b84f9152191e0018e9a : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_dd806eb82ac02b84f9152191e0018e9a>();
        ...
        {
			["3110cfaea09c4dac92f501522c3faca2"] = new Binding_dd806eb82ac02b84f9152191e0018e9a_3110cfaea09c4dac92f501522c3faca2(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_dd806eb82ac02b84f9152191e0018e9a()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_dd806eb82ac02b84f9152191e0018e9a Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_dd806eb82ac02b84f9152191e0018e9a>();
            this.bridge = bridge;
