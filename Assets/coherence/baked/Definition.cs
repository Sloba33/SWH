...
namespace Coherence.Generated
{
    ...
    {
        public const string schemaId = "e536246bf2824a0c570e3270121271fed925a349";
        ...
        public const uint Internal_01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153 = 18;
        public const uint Internal_b6fbc467c14a340499ee5aae55a3519c_2197336975981693810 = 19;
        ...
        private static readonly Dictionary<uint, string> componentNamesForTypeIds = new Dictionary<uint, string>()
        {
            ...
            { 16, "AssetId" },
            { 17, "GenericScale" },
            { 18, "_01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153" },
            { 19, "_b6fbc467c14a340499ee5aae55a3519c_2197336975981693810" },
        };
            ...
            IInBitStream bitStream, Logger logger)
        {
            ...
            switch (componentType)
            {
                ...
                case Internal_01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153:
                    return _01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153.Deserialize(referenceSimulationFrame, inProtocolStream);
                case Internal_b6fbc467c14a340499ee5aae55a3519c_2197336975981693810:
                    return _b6fbc467c14a340499ee5aae55a3519c_2197336975981693810.Deserialize(referenceSimulationFrame, inProtocolStream);
                default:
            ...
            AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream protocolStream, Logger logger)
        {
            switch (serializeAs)
            {
                ...
                case Internal_01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153:
                    return _01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153.Serialize((_01629b96b1e4f4cc5a8a96c2f8971ab7_5495683855552343153)data, isRefSimFrameValid, referenceSimulationFrame, protocolStream, logger);
                case Internal_b6fbc467c14a340499ee5aae55a3519c_2197336975981693810:
                    return _b6fbc467c14a340499ee5aae55a3519c_2197336975981693810.Serialize((_b6fbc467c14a340499ee5aae55a3519c_2197336975981693810)data, isRefSimFrameValid, referenceSimulationFrame, protocolStream, logger);
                default:
