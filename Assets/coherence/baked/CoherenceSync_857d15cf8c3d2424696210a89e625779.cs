...
namespace Coherence.Generated
{
    ...
    public class Binding_857d15cf8c3d2424696210a89e625779_0a91cac9ca6440799d2adb51a7402aea : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_857d15cf8c3d2424696210a89e625779 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_857d15cf8c3d2424696210a89e625779>();
        ...
        {
			["0a91cac9ca6440799d2adb51a7402aea"] = new Binding_857d15cf8c3d2424696210a89e625779_0a91cac9ca6440799d2adb51a7402aea(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_857d15cf8c3d2424696210a89e625779()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_857d15cf8c3d2424696210a89e625779 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_857d15cf8c3d2424696210a89e625779>();
            this.bridge = bridge;
