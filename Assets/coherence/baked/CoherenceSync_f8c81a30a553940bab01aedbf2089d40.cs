...
namespace Coherence.Generated
{
    ...
    public class Binding_f8c81a30a553940bab01aedbf2089d40_09058e8e40aa4e5493308c2df4b98173 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_f8c81a30a553940bab01aedbf2089d40 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_f8c81a30a553940bab01aedbf2089d40>();
        ...
        {
			["09058e8e40aa4e5493308c2df4b98173"] = new Binding_f8c81a30a553940bab01aedbf2089d40_09058e8e40aa4e5493308c2df4b98173(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_f8c81a30a553940bab01aedbf2089d40()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_f8c81a30a553940bab01aedbf2089d40 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_f8c81a30a553940bab01aedbf2089d40>();
            this.bridge = bridge;
