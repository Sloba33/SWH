/// <summary>
/// Carries the chosen <see cref="BotReplay"/> from the matchmaking scene into the
...
/// <c>GameManager</c> reads it in Start to decide between a Coherence-connected
...
/// static fields. A BotReplay is a ScriptableObject asset, so the reference stays
/// valid across the load.
/// </summary>
public static class BotMatchContext
{
    public static BotReplay PendingReplay;
